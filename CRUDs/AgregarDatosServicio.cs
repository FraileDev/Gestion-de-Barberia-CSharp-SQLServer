    ...
    internal class AgregarDatosServicio
    {
        public static bool AgregarDatos(Servicio servicio)
        {
            try
            {
                ...
                string query = "INSERT INTO servicio(id_barbero, nombre_barbero, tipo_servicio, fecha, precio) VALUES ('" + servicio.Id_barbero + "','" + servicio.Nombre_barbero + "','" + servicio.Tipo_servicio + "','" + servicio.Fecha + "','" + servicio.Precio + "');";
